...
const AddTeam = ({ isOpen, closeModal, team, id }) => {
              ...
              >
                  ...
                  <div className=" w-full">
                    <div className="grid grid-cols-1 gap-x-4 gap-y-2">
                      ...
                      <div className="col-span-1 flex flex-col gap-1">
                        <label htmlFor="">Choose Team Logo</label>
                ...
                <div className="mt-4">
                  <button className="btn-primary">
                    {loading? 'Loading...'  :  team ? "Update" : "Add"}
                  </button>
                </div>
              </Dialog.Panel>
            </Transition.Child>
